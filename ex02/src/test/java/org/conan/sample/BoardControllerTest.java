...
public class BoardControllerTest {
	...
	public void testModify() throws Exception{
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", "1").param("title", "해바라기4").param("content", "123오태식이 돌아왔구나 반갑다 해바라기아줌마애긴 들었다")
				.param("writer", "오태식이~11")).andReturn().getModelAndView().getViewName();
		log.info(resultPage);
	}
