...
$(document).ready(function(){
	//웹페이지가 로딩이 완료되고 자바스크립트문이 시작되게 함.
		...
		$(uploadResultArr).each(function(i, obj){
			if(!obj.image){
				...
				str += "<li><div><a href='/download?fileName="+
						fileCallPath+"'><img src='/resources/images/attach.png'>"+obj.fileName+"</a>"+
				...
				str += "<li><a href=\"javascript:showImage(\'"+originPath+"\')\"><img src='/display?fileName="
						+fileCallPath+"'><span data-file=\'"+fileCallPath+"\' data-type='image'>[x]</span></li>";
			}
		});
